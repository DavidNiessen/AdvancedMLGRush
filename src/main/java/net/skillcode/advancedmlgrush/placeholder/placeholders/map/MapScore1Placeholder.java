...
@Singleton
public class MapScore1Placeholder extends Placeholder {

    private final MapInstanceManager mapInstanceManager;

    @Inject
    public MapScore1Placeholder(final @NotNull MapInstanceManager mapInstanceManager) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        ...
        return String.valueOf(mapInstance.getMapStats().getScore(0));
    }
}
