...
public class Wins6Placeholder extends Placeholder {

    private final Ranking ranking;

    @Inject
    public Wins6Placeholder(final @NotNull Ranking ranking) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(ranking.getWinsByRanking(6));
    }
}
