...
@Singleton
public class MapTemplatesPlaceholder extends Placeholder {

    private final MapManager mapManager;

    @Inject
    public MapTemplatesPlaceholder(final @NotNull MapManager mapManager) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(mapManager.getMapTemplates2x1().size() + mapManager.getMapTemplates4x1().size());
    }
}
