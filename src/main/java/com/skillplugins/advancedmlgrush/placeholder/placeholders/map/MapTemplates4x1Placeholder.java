...
@Singleton
public class MapTemplates4x1Placeholder extends Placeholder {

    private final MapManager mapManager;

    @Inject
    public MapTemplates4x1Placeholder(final @NotNull MapManager mapManager) {
        this.mapManager = mapManager;
    }

    @Override
    public String identifier() {
        return "%map_templates_4x1%";
    }

    @Override
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(mapManager.getMapTemplates4x1().size());
    }
}
