...
@Singleton
public class PlacedBlocksPlaceholder extends Placeholder {

    private final SQLDataCache sqlDataCache;

    @Inject
    public PlacedBlocksPlaceholder(final @NotNull SQLDataCache sqlDataCache) {
        this.sqlDataCache = sqlDataCache;
    }

    @Override
    public String identifier() {
        return "%stats_placed_blocks%";
    }
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        ...
        return String.valueOf(sqlDataCache.getSQLData(player).getStatsPlacedBlocks());
    }
