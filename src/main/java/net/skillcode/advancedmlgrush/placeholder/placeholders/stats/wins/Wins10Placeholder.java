...
public class Wins10Placeholder extends Placeholder {

    private final Ranking ranking;

    @Inject
    public Wins10Placeholder(final @NotNull Ranking ranking) {
        this.ranking = ranking;
    }

    @Override
    public String identifier() {
        return "%stats_wins_10%";
    }

    @Override
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(ranking.getWinsByRanking(10));
    }
}
