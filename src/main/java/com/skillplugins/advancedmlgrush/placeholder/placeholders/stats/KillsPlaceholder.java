...
@Singleton
public class KillsPlaceholder extends Placeholder {

    private final SQLDataCache sqlDataCache;

    @Inject
    public KillsPlaceholder(final @NotNull SQLDataCache sqlDataCache) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        ...
        return String.valueOf(sqlDataCache.getSQLData(player).getStatsKills());
    }
