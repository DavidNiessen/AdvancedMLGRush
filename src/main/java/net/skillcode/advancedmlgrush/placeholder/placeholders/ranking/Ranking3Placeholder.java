...
@Singleton
public class Ranking3Placeholder extends Placeholder {

    private final Ranking ranking;

    @Inject
    public Ranking3Placeholder(final @NotNull Ranking ranking) {
        this.ranking = ranking;
    }

    @Override
    public String identifier() {
        return "%stats_ranking_3%";
    }

    @Override
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return ranking.getPlayerByRanking(3).orElse(getNullValue());
    }
}
