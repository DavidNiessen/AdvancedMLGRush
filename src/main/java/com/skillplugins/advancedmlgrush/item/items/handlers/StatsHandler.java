...
import com.skillplugins.advancedmlgrush.inventory.inventories.StatsInventory;
...
@Singleton
public class StatsHandler implements EventHandler {
        ...
        return new EventListener<PlayerInteractEvent>(PlayerInteractEvent.class, EventListenerPriority.MEDIUM) {
            ...
            protected void onEvent(final @NotNull PlayerInteractEvent event) {
                if (event.getAction() == Action.RIGHT_CLICK_AIR
                    ...
                    if (itemUtils.compare(clickedItem, EnumItem.STATS, Optional.of(player))) {
