...
import net.skillcode.advancedmlgrush.game.map.setup.step.SetupSteps4x1;
...
public class MapSetup4x1 extends MapSetup {
    ...
    Optional<MapFile> createMapFile(final @NotNull List<Object> objects, final @NotNull String mapName) {
        if (objects.size() == 14) {
            ...
            return Optional.of(new MapFile(MapType.M4x1, mapName, icon, data, blocks.get(), maxBuildHeight, deathHeight,
