...
public class Wins7Placeholder extends Placeholder {

    private final Ranking ranking;

    @Inject
    public Wins7Placeholder(final @NotNull Ranking ranking) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(ranking.getWinsByRanking(7));
    }
}
