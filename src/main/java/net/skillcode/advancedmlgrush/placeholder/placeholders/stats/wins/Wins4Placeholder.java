...
public class Wins4Placeholder extends Placeholder {

    private final Ranking ranking;

    @Inject
    public Wins4Placeholder(final @NotNull Ranking ranking) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        return String.valueOf(ranking.getWinsByRanking(4));
    }
}
