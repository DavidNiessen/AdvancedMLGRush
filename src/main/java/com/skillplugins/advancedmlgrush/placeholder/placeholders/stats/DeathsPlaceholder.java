...
@Singleton
public class DeathsPlaceholder extends Placeholder {

    private final SQLDataCache sqlDataCache;

    @Inject
    public DeathsPlaceholder(final @NotNull SQLDataCache sqlDataCache) {
    ...
    public String onRequest(final @NotNull Optional<Player> optionalPlayer) {
        ...
        return String.valueOf(sqlDataCache.getSQLData(player).getStatsDeaths());
    }
